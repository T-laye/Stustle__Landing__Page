...
const serviceDetails = [
  {
    ...
    description:
      'We are available to run errands for you i.e Market Shopping, gas refill, dirt disposal, deliveries e.t.c',
  },
  // {
  //   title: 'Food services',
  ...
  },
  {
    ...
    description:
      'We have skilled personnels available to help with assignments, projects etc',
  },
  // {
  //   title: 'Tech',
  ...
  // },
  {
    ...
    icon: <GiComb size={24} />,
    description:
      'Get a nice hair cut, make your wigs or get your hair fixed, make up services etc.',
  },
  // {
