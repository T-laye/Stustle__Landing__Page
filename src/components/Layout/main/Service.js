  ...
  return (
    <section id="services">
      <div className="flex flex-col items-center">
        ...
        <div>
          <div className="flex flex-wrap gap-4 justify-center mt-6 md:grid grid-cols-3 md:gap-6 xl:gap-x-48 xl:gap-y-20 xl:mb-14 lg:gap-x-20 lg:gap-y-10 lg:mt-8 lg:w-5/6 sm:gap-x-2 md:w-6/7 mx-auto">
            {renderService}
          </div>
        </div>
      </div>
